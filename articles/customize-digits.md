...
vignette, we guide users on how to customize the number of decimal
places displayed in the tables.
...
Users can adjust the decimal precision by specifying the `digits = ...`
argument within the
[`format_ae_forestly()`](https://merck.github.io/forestly/reference/format_ae_forestly.md)
function. By default, `digits = 1` is set, displaying values with one
decimal place. In the example below, we demonstrate how to increase this
